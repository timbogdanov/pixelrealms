...
func _gen_shop() -> void:
	# 0=clear 1=roof 2=roof_border 3=wall 4=wall_border 5=window
	# 6=door 7=handle 8=stone 9=stone_dark 10=chimney
	var p: Array = [
		Color(0,0,0,0), Color(0.65,0.18,0.12), Color(0.45,0.12,0.08),
		Color(0.78,0.62,0.35), Color(0.55,0.45,0.28), Color(0.3,0.45,0.7),
		Color(0.45,0.3,0.15), Color(0.85,0.7,0.3), Color(0.5,0.48,0.44),
		Color(0.38,0.36,0.34), Color(0.35,0.3,0.25)]
	shop_tex = _make_tex(16, 16, [
		...
		[0, 4, 3, 5, 5, 3, 3, 3, 3, 3, 3, 5, 5, 3, 4, 0],
		[0, 4, 3, 5, 5, 3, 3, 3, 3, 3, 3, 5, 5, 3, 4, 0],
		[0, 4, 3, 3, 3, 3, 6, 6, 6, 6, 3, 3, 3, 3, 4, 0],
		[0, 4, 3, 3, 3, 3, 6, 6, 6, 6, 3, 3, 3, 3, 4, 0],
		[0, 4, 3, 3, 3, 3, 6, 6, 7, 6, 3, 3, 3, 3, 4, 0],
